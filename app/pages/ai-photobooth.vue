...
<template>
  <main class="bg-black pt-10 text-zinc-100">
    ...
    >
      ...
      >
        <div class="flex flex-col items-center gap-8">
          ...
          <ul class="grid gap-5 md:grid-cols-2">
            <li>
              <article class="flex h-full max-w-md rounded-2xl border border-zinc-800 bg-zinc-900/70 p-4">
        ...
        <div class="w-full max-w-2xl overflow-hidden  border border-zinc-800 bg-zinc-900/70 p-2">
          <ClientOnly>
            <BeforeAfter />
          </ClientOnly>
        </div>
      ...
      >
        <h2 class="text-2xl font-bold uppercase tracking-wide text-white md:text-3xl">
          How It Works
        </h2>
        ...
        <div class="flex flex-col gap-6 md:flex-row">
          <div class="max-w-sm flex-1 border border-zinc-800 bg-zinc-900/70 p-4">
            ...
            <h3 class="py-3 text-center text-2xl font-bold text-white">Take a photo</h3>
          ...
          <div class="max-w-sm flex-1  border border-zinc-800 bg-zinc-900/70 p-4">
            ...
            <h3 class="py-3 text-center text-2xl font-bold text-white">A.I Magic</h3>
            <p class="leading-7 text-zinc-300">
